...
class FoodsModel(models.Model):
    ...
    category = fields.Many2many("menu_app.category_model",relation="menu_app_category_model2foods_model", string="Category")
    ingridients = fields.Many2many("menu_app.ingridients_model",relation="menu_app_ingridients_model2foods_model", string="Ingridients")
